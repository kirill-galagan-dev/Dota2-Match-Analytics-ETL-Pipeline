...
def run_matches_etl():
    ...
    for col in ['last_hits', 'gold_per_min', 'xp_per_min']:
    ...
    players_performance_df = df[[
        'match_id', 'player_id', 'hero_id', 'kills', 'deaths', 'assists',
        'last_hits', 'side', 'is_win', 'gold_per_min', 'xp_per_min'
    ]].copy()
    ...
    try:
        ...
        player_query = """
                       INSERT INTO match_players (match_id, player_id, hero_id, kills, deaths, assists,
                                                  last_hits, side, is_win, gold_per_min, xp_per_min)
